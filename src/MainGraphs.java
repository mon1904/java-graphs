...
public class MainGraphs {
	...
	public static int select_option(){
		...
		public static void main(String[] args) {
		    ...
		    LinkedList  <Integer> neighbors = (LinkedList<Integer>) m.getNeighbors(4);
			for (int i=0; i<neighbors.size(); i++)
				System.out.print(neighbors.get(i) + ", "); 
			System.out.println(" ]");	
			System.out.println("Degree of vertex 4: " + m.getDegree(1)); 
			System.out.println("Degree of vertex 3: " + m.getDegree(2)); 
			System.out.println(" ");	
			...
			//-------------------------------------		
			System.out.println("TEST 8: We get the details of the graph");
			System.out.println("Graph Vertices: " + m.numVerts()); 
			System.out.println("Graph Edges: " + m.numEdges()); 
			System.out.println(" ");
		}
